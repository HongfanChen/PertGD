...
#' train_gd(PAGD, params1, gd, obj_f, 20)
#' 
## Trainer function, can be used to train other algorithms: -------------------
train_gd = function(trainer, params, gd, obj_f, epoch){
  results = params[[1]]
  for(i in 1:epoch){
